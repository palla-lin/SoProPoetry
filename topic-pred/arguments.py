...
def parse_arguments():
    ...
    parser.add_argument("dataset_obj", help="path to pickle dataset")
    ...
    parser.add_argument("-epochs", default=20, type=int, help='number of training epochs [default: 10]')
    parser.add_argument("-dropout", default=0.3, type=float, help='the probability for dropout [default: 0.25]')
